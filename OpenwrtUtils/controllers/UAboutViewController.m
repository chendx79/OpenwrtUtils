...
- (void)viewDidLoad {
    ...
    self.systemInfo = [[URouterConfig sharedInstance] systemInfo];
    self.systemBoard = [[URouterConfig sharedInstance] systemBoard];
    self.diskInfo = [[URouterConfig sharedInstance] diskInfo];
}
