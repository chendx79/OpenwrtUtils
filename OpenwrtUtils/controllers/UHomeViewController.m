...
- (void)viewDidLoad {
    ...
    [[RACSignal combineLatest:@[RACObserve([URouterConfig sharedInstance], isBoxAvailable)] reduce:^(NSNumber *isBoxAvailable) {
    ...
    [[RACSignal combineLatest:@[RACObserve([URouterConfig sharedInstance], isBoxLoggedin)] reduce:^(NSNumber *isBoxLoggedin) {
    ...
    [[RACSignal combineLatest:@[RACObserve([URouterConfig sharedInstance], isWiFiConnected)] reduce:^(NSNumber *isWiFiConnected) {
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    if (buttonIndex == alertView.firstOtherButtonIndex) {
        ...
        [self showLoading];
        [[URouterConfig sharedInstance] loginWithPassword:pwdField.text result:^(BOOL success) {
            [self hideLoading];
        }];
    }
}
